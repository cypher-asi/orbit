...
/// Path parameters for `/repos/{org_id}/{repo}/commits`.
...
/// Path parameters for `/repos/{org_id}/{repo}/commits/{sha}`.
#[derive(Debug, Deserialize)]
pub struct OrgRepoShaPath {
    pub org_id: uuid::Uuid,
    pub repo: String,
    pub sha: String,
}

/// Path parameters for `/repos/{org_id}/{repo}/tree/{ref}/{*path}` and
/// `/repos/{org_id}/{repo}/blob/{ref}/{*path}`.
#[derive(Debug, Deserialize)]
pub struct OrgRepoRefPath {
    pub org_id: uuid::Uuid,
    pub repo: String,
    #[serde(rename = "ref")]
    pub ref_name: String,
...
/// Query parameters for `GET /repos/{org_id}/{repo}/commits`.
#[derive(Debug, Deserialize)]
...
/// GET /repos/{org_id}/{repo}/commits -- List commits for a branch or ref.
...
/// GET /repos/{org_id}/{repo}/commits/{sha} -- Get commit details.
async fn get_commit(
    OptionalAuth(user): OptionalAuth,
    State(state): State<AppState>,
    Path(path): Path<OrgRepoShaPath>,
...
/// GET /repos/{org_id}/{repo}/tree/{ref}/{*path} -- Browse repository tree.
async fn browse_tree(
    OptionalAuth(user): OptionalAuth,
    State(state): State<AppState>,
    Path(path): Path<OrgRepoRefPath>,
...
/// GET /repos/{org_id}/{repo}/blob/{ref}/{*path} -- Get file content.
async fn get_blob(
    OptionalAuth(user): OptionalAuth,
    State(state): State<AppState>,
    Path(path): Path<OrgRepoRefPath>,
...
/// GET /repos/{org_id}/{repo}/commits/{sha}/diff -- Get commit diff.
...
///
/// Mounts:
/// - `GET /repos/{org_id}/{repo}/commits`              -- list commits
/// - `GET /repos/{org_id}/{repo}/commits/{sha}`         -- get commit details
/// - `GET /repos/{org_id}/{repo}/commits/{sha}/diff`    -- get commit diff
/// - `GET /repos/{org_id}/{repo}/tree/{ref}/{*path}`    -- browse tree
/// - `GET /repos/{org_id}/{repo}/blob/{ref}/{*path}`    -- get file content
pub fn commits_routes() -> Router<AppState> {
    Router::new()
        .route("/repos/{org_id}/{repo}/commits", get(list_commits))
